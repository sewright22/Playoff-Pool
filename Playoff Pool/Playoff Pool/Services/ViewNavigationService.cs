...
namespace Playoff_Pool.Services
{
    ...
    public class ViewNavigationService : IViewNavigationService
    {
        ...
        private MasterDetailPage MainPage { get; set; } 

        public ViewNavigationService() { }

        public void Initialize()
        {
            //Configure("Home", typeof(WelcomePage));
        }
        ...
        public async Task NavigateModalAsync(string pageKey, object parameter, bool animated = true)
        {
            ...
            await CurrentNavigationPage.Navigation.PushModalAsync(modalNavigationPage, animated).ConfigureAwait(false);
        ...
        {
            MainPage = (MasterDetailPage)mainPage;
        }
    }
}
